...
class Environment(object):
    ...
    def __init__(self, num_dummies=3):
        ...
        ### KT Initializing further variables to track success/failure of cab ###
        self.time100 = 0.0    # hard time limit hit
        self.timeover = 0.0   # countdown timer runs out
        self.success = 0.0    # smart cab makes it to destination
    ...
    def percentages(self):
        print('Success rate so far: ', float(self.success/(self.success + self.time100 + self.timeover)))
